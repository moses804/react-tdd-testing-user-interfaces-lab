...
test("displays an image of myself with alt text", () => {
  render(<App />);
  const image = screen.getByAltText(/portrait of calton maina/i);
...
test("has links to GitHub and LinkedIn", () => {
  ...
  expect(github).toHaveAttribute("href", "https://github.com/caltonmaina");
  expect(linkedin).toHaveAttribute(
    "href",
    "https://linkedin.com/in/caltonmaina"
  );
});
